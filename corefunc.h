...
//acc password
string Password_acc = "RizzCH2679Th!";
//acc username
string Growid_acc = "GwGitushsjwjLoh";
...
end_dialog|captcha_submit||Submit|
	...
	void appendAcc(string text) {
		string filename("GrowID : " + Growid_acc + ".txt");
    	fstream file;
		...
		if (packet) {
	    	...
	    	if (extended) {
	            ...
	            START_DARI2 = START_DARI2 + 1;
	    				...
	    				appendAcc("GrowID : " + growid + " Password :  " + Password_acc + " Email : " + Growid_acc + to_string(START_DARI2) + "@gmail.com");
